...
node_t* create_list_of_groups(node_t **node, FILE *f) // создание списка из файла
{
	node_t *tmp;
	tmp = (*node);
...
///////////////////////////////////////////////////////////////////////
	...
	FILE *f4 = fopen("persons3.txt", "r");
	char *name4 = (char*)malloc(70);
	char *group4 = (char*)malloc(10);
	node_t *head4 = NULL;
	data_t *data_node4;
	while(fscanf(f4, "%s%s", name4,group4) != EOF)
	{
		data_node4 = create_data_node(name4,group4);
		head4 = add_node(head4, data_node4);
		name4 = (char*)malloc(20);
		group4 = (char*)malloc(10);
	}


	printf("\n----------------TEST 4-----------------\n");
	printf("\nФамилии одинаковые, группы разные. \n");
	printf("\nДо сортировки.\n");
	apply(head4, print_node, "%10s %10s\n");
