...
# 1 "/usr/lib/gcc/x86_64-pc-msys/6.3.0/include/stddef.h" 1 3 4
# 216 "/usr/lib/gcc/x86_64-pc-msys/6.3.0/include/stddef.h" 3 4
typedef long unsigned int size_t;
# 46 "/usr/include/sys/cdefs.h" 2 3 4
# 36 "/usr/include/stdio.h" 2 3 4
# 1 "/usr/lib/gcc/x86_64-pc-msys/6.3.0/include/stddef.h" 1 3 4
# 149 "/usr/lib/gcc/x86_64-pc-msys/6.3.0/include/stddef.h" 3 4
typedef long int ptrdiff_t;
# 328 "/usr/lib/gcc/x86_64-pc-msys/6.3.0/include/stddef.h" 3 4
typedef short unsigned int wchar_t;
# 426 "/usr/lib/gcc/x86_64-pc-msys/6.3.0/include/stddef.h" 3 4
typedef struct {
...
# 1 "/usr/lib/gcc/x86_64-pc-msys/6.3.0/include/stdarg.h" 1 3 4
# 40 "/usr/lib/gcc/x86_64-pc-msys/6.3.0/include/stdarg.h" 3 4
...
# 1 "/usr/lib/gcc/x86_64-pc-msys/6.3.0/include/stddef.h" 1 3 4
# 357 "/usr/lib/gcc/x86_64-pc-msys/6.3.0/include/stddef.h" 3 4
...
# 8 "unit_test_read_file.c"
int read_file(FILE *f, int* pb, int *size)
{
    int* pcur = pb;
    if (size != 
# 11 "unit_test_read_file.c" 3 4
               ((void *)0)
# 11 "unit_test_read_file.c"
                   )
        *size = 0;
    int num;
    if (pb == 
# 14 "unit_test_read_file.c" 3 4
             ((void *)0) 
# 14 "unit_test_read_file.c"
                  || size == 
# 14 "unit_test_read_file.c" 3 4
                             ((void *)0) 
# 14 "unit_test_read_file.c"
...
void test_read(void)
{
    ...
    if (read_file(
# 49 "unit_test_read_file.c" 3 4
                 ((void *)0)
# 49 "unit_test_read_file.c"
                     , a, &size) != -1)
    {
        err_count++;
    }
    ...
    if (read_file(f, 
# 54 "unit_test_read_file.c" 3 4
                    ((void *)0)
# 54 "unit_test_read_file.c"
                        , &size) != -1)
    {
        err_count++;
        fclose(f);
    ...
    f = fopen("test.1.txt", "r");
    if (read_file(f, a, 
# 60 "unit_test_read_file.c" 3 4
                       ((void *)0)
# 60 "unit_test_read_file.c"
                           ) != -1)
    {
        err_count++;
        fclose(f);
    ...
    if (read_file(t2, a, &size) != 0)
    {
        err_count++;
    }
    if (read_file(t3, a, &size) != 0)
    {
        err_count++;
    }
    if (read_file(t4, a, &size) != 0)
    {
        err_count++;
    }
    if (read_file(t5, a, &size) != -3)
    {
        err_count++;
    }
